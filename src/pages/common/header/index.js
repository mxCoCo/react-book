...
const Header = (props) => {
  const { focused, moveInTipList, getTipList, handleChangeMoveIn, handleChangePageNo, cacheTipList, pageNo, pageSize, tipList } = props
        ...
        <Nav>
          ...
          <SearchItem>{/* 搜索框 */}
            ...
            >
              <SearchTipTitle>
                热门
                <SearchTipTitleSwitch onClick={handleChangePageNo.bind(this, pageNo)}>
                  <SwitchRefresh className="iconfontRefresh">&#xe619;</SwitchRefresh>
                  换一批
                </SearchTipTitleSwitch>
              </SearchTipTitle>
              <SearchTipList>
